...
const PLACEHOLDER_MAP: Record<string, Professional> = {
  'dr-rajan-nair': { id: 'pp1', slug: 'dr-rajan-nair', name: 'Dr. Rajan Nair', name_ml: null, profession: 'Cardiologist', profession_ml: 'കാർഡിയോളജിസ്റ്റ്', category: 'medical', category_ml: 'വൈദ്യം', emirate: 'Dubai', emirate_ml: null, photo_url: 'https://images.unsplash.com/photo-1537368910025-700350fe46c7?w=400&q=80', phone: '+971501234567', whatsapp: '+971501234567', email: 'dr.rajan@example.com', website: null, bio: 'Dr. Rajan Nair is a highly experienced Cardiologist with over 18 years of practice in Dubai. He completed his MBBS from Kerala and MD (Cardiology) from AIIMS New Delhi, followed by a fellowship in Interventional Cardiology from the UK. He has performed over 2,000 cardiac procedures and is known for his compassionate patient care within the UAE Malayali community.', bio_ml: null, rating_avg: 4.9, review_count: 87, verified: true, featured: true, followers: null, tags: ['Cardiology', 'Interventional', 'Heart Surgery', 'Dubai Healthcare City'], status: 'active', created_at: new Date().toISOString() },
}
