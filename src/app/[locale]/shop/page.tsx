...
// ── Placeholder shop listings shown when DB is empty ─────────────────────────
const SB = { listing_id: null, vendor_logo_url: null, vendor_name_ml: null, vendor_emirate_ml: null, vendor_verified: true, vendor_whatsapp: '+971501234567', vendor_phone: '+971501234567', name_ml: null, description_ml: null, category_ml: null, original_price: null, currency: 'AED', unit: null, unit_ml: null, images: [], review_count: 0, is_active: true, is_featured: false, is_bestseller: false, duration: null, slots: [], tags: [], tags_ml: [], sort_order: 0 }
const SHOP_PLACEHOLDER: MarketplaceListing[] = [
  { ...SB, id: 'sp1',  vendor_slug: 'kerala-kitchen-dubai',    vendor_name: 'Kerala Kitchen Dubai',    vendor_emirate: 'Dubai',     listing_type: 'product',        name: 'Kerala Beef Curry (1kg)',          category: 'Food & Grocery',    price: 45,  original_price: 55,  rating_avg: 4.8, review_count: 124, is_featured: true,  is_bestseller: true,  image_url: 'https://images.unsplash.com/photo-1585937421612-70a008356fbe?w=400&q=80', description: 'Authentic Kerala-style slow-cooked beef curry made with fresh coconut and roasted spices. Ready to heat and serve.', created_at: new Date().toISOString() },
  { ...SB, id: 'sp2',  vendor_slug: 'dr-rajan-clinic-dubai',   vendor_name: 'Dr. Rajan Clinic',        vendor_emirate: 'Dubai',     listing_type: 'appointment',    name: 'General Physician Consultation',  category: 'Healthcare',        price: 150, original_price: null, rating_avg: 4.9, review_count: 87,  is_featured: true,  is_bestseller: false, duration: '30 mins', image_url: 'https://images.unsplash.com/photo-1559757148-5c350d0d3c56?w=400&q=80', description: 'Consult our experienced General Physician. Covers diagnosis, prescriptions, and health advice. Malayalam speaking doctor.', created_at: new Date().toISOString() },
  { ...SB, id: 'sp3',  vendor_slug: 'malabar-spices-sharjah',  vendor_name: 'Malabar Spices Sharjah',  vendor_emirate: 'Sharjah',   listing_type: 'product',        name: 'Kerala Spice Gift Box (500g)',    category: 'Food & Grocery',    price: 89,  original_price: 110, rating_avg: 4.7, review_count: 56,  is_featured: false, is_bestseller: true,  image_url: 'https://images.unsplash.com/photo-1596040033229-a9821ebd058d?w=400&q=80', description: 'Premium Kerala spice collection — turmeric, cardamom, black pepper, cinnamon and cloves sourced directly from Wayanad farms.', created_at: new Date().toISOString() },
  { ...SB, id: 'sp4',  vendor_slug: 'glamour-beauty-dubai',    vendor_name: 'Glamour Beauty Lounge',   vendor_emirate: 'Dubai',     listing_type: 'appointment',    name: 'Bridal Makeup Package',           category: 'Beauty & Wellness', price: 800, original_price: 1000,rating_avg: 4.9, review_count: 43,  is_featured: true,  is_bestseller: true,  duration: '3 hours', image_url: 'https://images.unsplash.com/photo-1487412947147-5cebf100ffc2?w=400&q=80', description: 'Complete bridal makeup and hair styling by our expert Kerala beauticians. Includes trial session, airbrush makeup, and saree draping.', created_at: new Date().toISOString() },
  { ...SB, id: 'sp5',  vendor_slug: 'techxpert-solutions',     vendor_name: 'TechXpert Solutions',     vendor_emirate: 'Dubai',     listing_type: 'direct_service', name: 'Website Development Package',     category: 'Technology',        price: 2500,original_price: 3500,rating_avg: 4.6, review_count: 31,  is_featured: false, is_bestseller: false, image_url: 'https://images.unsplash.com/photo-1547658719-da2b51169166?w=400&q=80', description: 'Professional business website with 5 pages, mobile-responsive design, WhatsApp integration, and 1-year hosting support.', created_at: new Date().toISOString() },
  { ...SB, id: 'sp6',  vendor_slug: 'ca-suresh-associates',    vendor_name: 'CA Suresh & Associates',  vendor_emirate: 'Abu Dhabi', listing_type: 'quote',          name: 'UAE Corporate Tax Filing',        category: 'Legal & Finance',   price: 0,   original_price: null, rating_avg: 4.8, review_count: 67,  is_featured: false, is_bestseller: false, image_url: 'https://images.unsplash.com/photo-1554224155-6726b3ff858f?w=400&q=80', description: 'Complete UAE Corporate Tax registration and annual filing by certified Chartered Accountants. Get a custom quote based on your business type.', created_at: new Date().toISOString() },
  { ...SB, id: 'sp7',  vendor_slug: 'kerala-bakery-ajman',     vendor_name: 'Kerala Bakery Ajman',     vendor_emirate: 'Ajman',     listing_type: 'product',        name: 'Plum Cake (1kg) - Christmas Special', category: 'Food & Grocery', price: 65,  original_price: 80,  rating_avg: 4.9, review_count: 98,  is_featured: false, is_bestseller: true,  image_url: 'https://images.unsplash.com/photo-1513558161293-cdaf765ed2fd?w=400&q=80', description: 'Traditional Kerala rum-soaked plum cake with nuts and dry fruits. Baked fresh daily. Perfect for gifting and celebrations.', created_at: new Date().toISOString() },
  { ...SB, id: 'sp8',  vendor_slug: 'movers-kerala-dubai',     vendor_name: 'Kerala Movers Dubai',     vendor_emirate: 'Dubai',     listing_type: 'quote',          name: 'Home Relocation Service',         category: 'Services',          price: 0,   original_price: null, rating_avg: 4.5, review_count: 112, is_featured: false, is_bestseller: false, image_url: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=400&q=80', description: 'Professional home and office relocation across UAE. Packing, moving, storage solutions. Free survey and custom quote for every move.', created_at: new Date().toISOString() },
  { ...SB, id: 'sp9',  vendor_slug: 'ayurveda-wellness-dubai',  vendor_name: 'Ayurveda Wellness Dubai', vendor_emirate: 'Dubai',     listing_type: 'appointment',    name: 'Kerala Ayurvedic Massage (60 min)', category: 'Beauty & Wellness', price: 250, original_price: 320, rating_avg: 4.8, review_count: 74,  is_featured: true,  is_bestseller: false, duration: '60 mins', image_url: 'https://images.unsplash.com/photo-1544161515-4ab6ce6db874?w=400&q=80', description: 'Authentic Kerala Abhyanga massage with warm herbal oils. Performed by certified Ayurvedic therapists from Kerala. Rejuvenate mind and body.', created_at: new Date().toISOString() },
  { ...SB, id: 'sp10', vendor_slug: 'gulf-legal-consultants',  vendor_name: 'Gulf Legal Consultants',  vendor_emirate: 'Dubai',     listing_type: 'contact_only',   name: 'UAE Visa & PRO Services',         category: 'Legal & Finance',   price: 0,   original_price: null, rating_avg: 4.7, review_count: 89,  is_featured: false, is_bestseller: false, image_url: 'https://images.unsplash.com/photo-1450101499163-c8848c66ca85?w=400&q=80', description: 'Complete visa processing, Emirates ID, trade license, and PRO services across all UAE emirates. 24/7 support in Malayalam.', created_at: new Date().toISOString() },
  { ...SB, id: 'sp11', vendor_slug: 'organic-kerala-store',    vendor_name: 'Organic Kerala Store',    vendor_emirate: 'Sharjah',   listing_type: 'product',        name: 'Cold-Pressed Coconut Oil (1L)',   category: 'Food & Grocery',    price: 35,  original_price: null, rating_avg: 4.6, review_count: 45,  is_featured: false, is_bestseller: false, image_url: 'https://images.unsplash.com/photo-1474979266404-7eaacbcd87c5?w=400&q=80', description: 'Pure cold-pressed virgin coconut oil from Kerala farms. No chemicals, no refining. Great for cooking, hair and skin care.', created_at: new Date().toISOString() },
  { ...SB, id: 'sp12', vendor_slug: 'tutors-kerala-uae',       vendor_name: 'Kerala Tutors UAE',       vendor_emirate: 'Abu Dhabi', listing_type: 'appointment',    name: 'CBSE/ICSE Home Tuition (1 Month)', category: 'Services',         price: 500, original_price: 700, rating_avg: 4.8, review_count: 38,  is_featured: false, is_bestseller: false, duration: '1 month', image_url: 'https://images.unsplash.com/photo-1434030216411-0b793f4b4173?w=400&q=80', description: 'Experienced Kerala teachers for CBSE/ICSE home tuition in Maths, Science and English. Classes 6-12. Malayalam medium available.', created_at: new Date().toISOString() },
]
...
export default function ShopPage() {
  ...
  useEffect(() => {
    getMarketplaceListings({ limit: 200 }).then(data => {
      setAllListings(data.length > 0 ? data : SHOP_PLACEHOLDER)
      setLoading(false)
    })
  }, [])
